...
-- CTRL S saves and returns to normal mode.
--

vim.keymap.set('i', '<C-s>', '<ESC>:w<CR>a', { desc = 'Save and return to edit mode' })
vim.keymap.set('n', '<C-s>', '<ESC>:w<CR>', { desc = 'Save and return to normal mode' })
